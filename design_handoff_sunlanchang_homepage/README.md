...
4. **Other experiments** — h3 26px/600, 3-col grid gap 20px. Cards: `#fdfcfa`, 1px border, radius 14px, padding 26px; status dot + label 12px, name 18px/600, desc 14px/1.5. Buzi card is a link to `https://sunlanchang.com/buzi` (hover: border darkens).
